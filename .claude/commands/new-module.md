...
7. Export slides.md to PDF via `slidev export`.
8. Export trainer-notes.md to PDF.
9. Run `git add`, commit with message `feat(module-X-Y): add <title>`, push, and open PR via `gh pr create`.
10. After PR is merged (ask user to confirm), checkout main, pull, delete the feature branch.